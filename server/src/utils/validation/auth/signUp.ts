...
export const sigUpValidation = [
  ...
  body(AUTH_FIELDS.role).trim().optional().isIn(['AUTHER', 'ADMIN']).withMessage('role must be either AUTHER or ADMIN'),
  ...
  body(AUTH_FIELDS.emailUpdates).trim().isBoolean().withMessage('Must be a boolean true or false'),
];
